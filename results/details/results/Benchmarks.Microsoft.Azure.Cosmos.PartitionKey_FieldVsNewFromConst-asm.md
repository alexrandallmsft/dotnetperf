...
```assembly
; Benchmarks.Microsoft.Azure.Cosmos.PartitionKey_FieldVsNewFromConst.Field()
...
## .NET 6.0.10 (6.0.1022.47605), X64 RyuJIT AVX2
```assembly
; Benchmarks.Microsoft.Azure.Cosmos.PartitionKey_FieldVsNewFromConst.NewFromConst()
