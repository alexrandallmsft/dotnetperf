...
```assembly
; Benchmarks.Microsoft.Azure.Cosmos.Microsoft_Azure_Cosmos_PartitionKey_Hardcoded.Field()
...
## .NET 6.0.10 (6.0.1022.47605), X64 RyuJIT AVX2
```assembly
; Benchmarks.Microsoft.Azure.Cosmos.Microsoft_Azure_Cosmos_PartitionKey_Hardcoded.NewFromConst()
